...
Check out this example on Dockerhub `here <https://hub.docker.com/r/chrishah/ncbi-blast>`_ - the basis for this image is hosted on Github `here <https://github.com/chrishah/ncbi-blast-docker>`
